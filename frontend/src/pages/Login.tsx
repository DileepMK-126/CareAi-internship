...
import { Brain, Mail, Lock, AlertCircle, Zap, ShieldCheck } from "lucide-react";
...
export default function Login() {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      const demoUser = {
        id: "demo_patient_01",
        email: "demo@careai.health",
        name: "Demo Clinical User",
        role: "patient",
      };
      localStorage.setItem("careai_user", JSON.stringify(demoUser));
      setUser(demoUser);
      navigate("/dashboard");
    } catch (err: any) {
      setError("Failed to initialize demo login session");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-xs">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[11px] text-slate-400 font-bold uppercase tracking-wider">Or Email Sign-In</span>
            <div className="flex-1 h-px bg-slate-200" />
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="doctor@careai.health"
          ...
          <div className="mt-4 pt-4 border-t border-slate-100">
            <button
              ...
              disabled={loading}
              className="w-full py-2 bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-700 rounded-lg font-bold text-xs transition-all flex items-center justify-center gap-1.5"
            >
        ...
        <div className="text-center text-[11px] text-slate-400 flex items-center justify-center gap-1.5">
          <ShieldCheck size={14} className="text-slate-400" /> HIPAA Compliant Clinical Platform Encryption
        </div>
      </div>
    </div>
  );
